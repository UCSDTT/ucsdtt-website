const rushEventData = [
  {
    location: 'Rimac',
    date: '10/9 Monday 7:30PM',
    name: 'Info Night',
    content: 'Come out to the first rush event to get a gist of what the fraternity is all about and meet the brothers of Theta Tau! Break the ice!',
    image: require('./images/info_night.webp'),
    safari: require('./images/info_night.jpg'),
  },
  {
    location: 'Triton Statue',
    date: '10/10 Tuesday 7:30PM',
    name: 'Meet N Greet',
    content: 'Well now is your chance to mingle with the brothers of Theta Tau -- speed-dating style. Get to know us and let us get to know you!',
    image: require('./images/meetngreet.webp'),
    safari: require('./images/meetngreet.jpg'),
  },
  {
    location: 'Triton Statue',
    date: '10/11 Wednesday 7:30PM',
...
const carouselData = [
  {
    ...
    'author': 'David Deng',
    'image': require('./images/ddeng_rush.jpg'),
    'smImage': require('./images/ddeng_rush.jpg'),
    'xsImage': require('./images/ddeng_rush.jpg'),
  },
  {
    ...
    'author': 'Judy Ho',
    'image': require('./images/judy_rush.jpg'),
    'smImage': require('./images/judy_rush.jpg'),
    'xsImage': require('./images/judy_rush.jpg'),
  },
  {
    ...
    'author': 'Aston Khor',
    'image': require('./images/aston_rush.jpg'),
    'smImage': require('./images/aston_rush.jpg'),
    'xsImage': require('./images/aston_rush.jpg'),
  },
  {
    ...
    'author': 'Jessica Tran',
    'image': require('./images/jess_rush.jpg'),
    'smImage': require('./images/jess_rush.jpg'),
    'xsImage': require('./images/jess_rush.jpg'),
  },
  {
    'quote': 'Theta Tau has taught me to focus on improvement instead of achievement. Run 0.5 miles farther than last week. Finish one more module of the project. With enough time, I’m able to achieve all the initial goals I set out to accomplish while feeling proud of myself the entire way there.',
    'author': 'Aamir Rasheed',
    'image': require('./images/aamir_rush.jpg'),
    'smImage': require('./images/aamir_rush.jpg'),
    'xsImage': require('./images/aamir_rush.jpg'),
  },
  {
    ...
    'author': 'Brian Lyu',
    'image': require('./images/blyu_rush.jpg'),
    'smImage': require('./images/blyu_rush.jpg'),
    'xsImage': require('./images/blyu_rush.jpg'),
  },
  {
    ...
    'image': require('./images/money_rush.jpg'),
    'smImage': require('./images/money_rush.jpg'),
    'xsImage': require('./images/money_rush.jpg'),
  },
];
