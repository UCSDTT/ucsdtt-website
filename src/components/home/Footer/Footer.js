          ...
          <Row className="show-grid">
            ...
            <Col xsOffset={2} xs={8} smOffset={0} sm={6} md={4} className="widget">
              ...
              <p>
                ...
                <a className="light-grey footer-contact" onClick={() => this.scrollToComp("faq")}> here</a>
              </p>
              <p>
            ...
            <Col xsOffset={2} xs={8} smOffset={3} sm={6} mdOffset={0} md={4} className="widget">
              ...
              <ul>
                ...
                <li><a className="light-grey" href='https://github.com/hillary/' target="_blank" rel="noopener noreferrer">Hillary Fan</a></li>
                <li><a className="light-grey" href='https://github.com/3605031/' target="_blank" rel="noopener noreferrer">Blake Huynh</a></li>
                <li><a className="light-grey" href='https://github.com/kaiserpk/' target="_blank" rel="noopener noreferrer">Kaiser Kim</a></li>
                <li><a className="light-grey" href='https://github.com/jeffreyzlee/' target="_blank" rel="noopener noreferrer">Jeffrey Lee</a></li>
              </ul>
            </Col>
          </Row>
        </Grid>
