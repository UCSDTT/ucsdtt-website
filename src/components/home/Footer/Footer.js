  ...
  render() {
    return (
      <Col xsOffset={2} xs={8} smOffset={0} sm={6} md={4} className="widget">
        ...
        <br />
        <p>
          For any questions or queries, you can find our FAQS and contact
          details
          <div
        ...
        <div className="media-icons">
          ...
          <a
            href="https://instagram.com/thetatau_ucsd/"
            target="_blank"
            rel="noopener noreferrer"
          >
      ...
      >
        ...
        <ul>
          ...
          <li>
            <a
              className="footer-links"
              href="https://github.com/kaiserpk/"
              target="_blank"
              rel="noopener noreferrer"
            >
              Kaiser Kim
          ...
          <li>
            <a
              className="footer-links"
              href="https://joshchao.herokuapp.com"
              target="_blank"
              rel="noopener noreferrer"
            >
              Joshua Chao
