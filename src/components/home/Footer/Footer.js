                ...
                <Col xsOffset={2} xs={8} smOffset={0} sm={6} md={4} className="widget">
                  <div className="widget-header">Visit our Neighboring Chapters</div><br/>
                      <ul className="footer-ul">
                        <li><a className="light-grey" href='http://www.thetatauuci.com/' target="_blank">UC Irvine</a></li>
                        <li><a className="light-grey" href='http://theta-tau-chi-chapter.herokuapp.com/' target="_blank">University of Arizona</a></li>
                        <li><a className="light-grey" href='http://www.thetataubruins.org/' target="_blank">UC Los Angeles</a></li>
                        <li><a className="light-grey" href='http://www.engr.ucr.edu/~thetatau/' target="_blank">UC Riverside</a></li>
                        <li><a className="light-grey" href='http://renothetatau.org/' target="_blank">University of Nevada, Reno</a></li>
                        <li><a className="light-grey" href='http://www.calthetatau.com/' target="_blank">UC Berkeley</a></li>
                        <li><a className="light-grey" href='http://pacific.orgsync.com/org/thetatau/About/' target="_blank">University of the Pacific</a></li>
                        <li><a className="light-grey" href='http://www.mdthetatau.org/' target="_blank">UC Merced</a></li>
                        <li><a className="light-grey" href='http://www.davisthetatau.com/' target="_blank">UC Davis</a></li>
                        <li><a className="light-grey" href='http://www.thetatau-dg.org/' target="_blank">Arizona State University</a></li>
                      </ul>
                </Col>
                <Col xsOffset={2} xs={8} smOffset={3} sm={6} mdOffset={0} md={4} className="widget"><div className="widget-header">Website Credits</div><br/>
                  <ul className="footer-ul">
                    <li><a className="light-grey" href='https://github.com/bchann/' target="_blank">Brian Chan</a></li>
